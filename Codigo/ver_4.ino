...
void setup(){
	...
	TCCR1B |= (1<<CS12) | (1<<CS10); // prescaller de 1024 para timer1
...
void atira_timer1(){
	...
	PORTC ^= (1<<PC1); // liga o laser
	while (TCNT1 <= 15625); // 1 segundo de tempo ativo para o laser
	PORTC ^= (1<<PC1); // desliga o laser
	TCNT1 = 0; // zera o contador
	while (TCNT1 <= 15625); // 1 segundo com o laser inativo
